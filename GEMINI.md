...
- `references/Resume_original.pdf` — the downloadable resume PDF
...
The resume content lives in `resume.html`; the downloadable PDF at `references/Resume_original.pdf` must be kept in sync manually.
